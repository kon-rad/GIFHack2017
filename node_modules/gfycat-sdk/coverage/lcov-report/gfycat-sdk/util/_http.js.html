...
<html lang="en">
<head>
    <title>Code coverage report for gfycat-sdk/util/_http.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">gfycat-sdk/util/</a> _http.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  var req = https.request(options.request, res =&gt; {
    switch (res.headers['content-encoding']) {
      case 'gzip' || <span class="branch-1 cbranch-no" title="branch not covered" >'deflate':</span>
...
&nbsp;
    output.on('end', () =&gt; {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (format !== 'html') {
        if (!body) body = {};
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Sat Nov 12 2016 10:50:42 GMT-0700 (MST)
</div>
</div>
